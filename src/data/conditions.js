const CONDITIONS = [
  {
    id: 'cold', img: '/boysneeze.png', title: 'Cold',
    lines: [
  ...
  {
    id: 'fever', img: '/boyfever.png', title: 'Fever',
    lines: [
  ...
  {
    id: 'cough', img: '/boycough.png', title: 'Cough',
    lines: [
  ...
  {
    id: 'headache', img: '/boyheadache.png', title: 'Headache',
    lines: [
  ...
  {
    id: 'toothache', img: '/boytooth.png', title: 'Toothache',
    lines: [
  ...
  {
    id: 'earache', img: '/boyear.png', title: 'Earache',
    lines: [
  ...
  {
    id: 'eye', img: '/boyeye.png', title: 'Eye Infection',
    lines: [
  ...
  {
    id: 'vomiting', img: '/boyvomit.png', title: 'Vomiting',
    lines: [
  ...
  {
    id: 'diarrhea', img: '/boypotty.png', title: 'Diarrhea',
    lines: [
  ...
  {
    id: 'skin', img: '/boyskin.png', title: 'Skin Allergy',
    lines: [
  ...
  {
    id: 'stomach', img: '/boystomach.png', title: 'Stomach Pain',
    lines: [
  ...
  {
    id: 'throat', img: '/boythroat.png', title: 'Throat Pain',
    lines: [
