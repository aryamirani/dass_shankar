const CONDITIONS = [
  {
    id: 'cold', img: '/Grade2/health/Problems/boysneeze.png', title: 'Cold',
    lines: [
  ...
  {
    id: 'fever', img: '/Grade2/health/Problems/boyfever.png', title: 'Fever',
    lines: [
  ...
  {
    id: 'cough', img: '/Grade2/health/Problems/boycough.png', title: 'Cough',
    lines: [
  ...
  {
    id: 'headache', img: '/Grade2/health/Problems/boyheadache.png', title: 'Headache',
    lines: [
  ...
  {
    id: 'toothache', img: '/Grade2/health/Problems/boytooth.png', title: 'Toothache',
    lines: [
  ...
  {
    id: 'earache', img: '/Grade2/health/Problems/boyear.png', title: 'Earache',
    lines: [
  ...
  {
    id: 'eye', img: '/Grade2/health/Problems/boyeye.png', title: 'Eye Infection',
    lines: [
  ...
  {
    id: 'vomiting', img: '/Grade2/health/Problems/boyvomit.png', title: 'Vomiting',
    lines: [
  ...
  {
    id: 'diarrhea', img: '/Grade2/health/Problems/boypotty.png', title: 'Diarrhea',
    lines: [
  ...
  {
    id: 'skin', img: '/Grade2/health/Problems/boyskin.png', title: 'Skin Allergy',
    lines: [
  ...
  {
    id: 'stomach', img: '/Grade2/health/Problems/boystomach.png', title: 'Stomach Pain',
    lines: [
  ...
  {
    id: 'throat', img: '/Grade2/health/Problems/boythroat.png', title: 'Throat Pain',
    lines: [
