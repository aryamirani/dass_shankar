...
export default function MathsExerciseEight({ onBack, onNextExercise }) {
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            {completedCount === totalCount && (
              <div style={{ textAlign: 'center', marginTop: 20, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20 }}>
                <div style={{ fontSize: 32, fontWeight: 900, color: '#4CAF50', animation: 'popIn 600ms cubic-bezier(.2,.9,.2,1) both' }}>
