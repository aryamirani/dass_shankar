...
const WORDS = [
  { id: 'cap', img: '/Grade1/english/VocabularyThreeAp/cap.png' },
  { id: 'map', img: '/Grade1/english/VocabularyThreeAp/map.png' },
  { id: 'tap', img: '/Grade1/english/VocabularyThreeAp/tap.png' }
]

const POSITIVE = ['👍 Good', '✅ Yes', '🌟 Nice', '🎉 Great', '😃 Yay', '👌 Ok']
const GENTLE = ['👎 Retry', '☹️ Try again', '❌ Wrong']

export default function VocabularyThreeAp({ onBack, onNextExercise }) {
  ...
  return (
    <div style={{ minHeight: '100vh', padding: 20, position: 'relative' }}>
      ...
      <div style={{ maxWidth: 980, margin: '0 auto' }}>
        <h2 style={{ textAlign: 'center', fontSize: 'clamp(28px, 6vw, 42px)', fontWeight: 900, color: '#333' }}>"ap" Vocabulary</h2>
      ...
      <div className="word-footer" style={{
        ...
        <span style={{ fontWeight: 800, color: '#1976d2' }}>"ap" Words:</span>
        {WORDS.map(w => (
