  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
      ...
      <div style={{ textAlign: 'center', background: 'rgba(255,255,255,0.0)', padding: 20 }}>
        ...
        <div style={{ height: 12 }} />
        <div style={{ fontSize: 18, color: 'white', opacity: 0.95, marginTop: 6, fontWeight: 600, animation: 'popIn 700ms cubic-bezier(.2,.9,.2,1) 120ms both' }}>
        ...
        <button
          ...
          onClick={onStart}
          style={{ padding: '12px 24px', fontSize: 18, animation: 'popIn 700ms cubic-bezier(.2,.9,.2,1) 260ms both', transformOrigin: 'center', background: 'white', color: '#ff512f', border: 'none' }}
