...
const SECTIONS = [
  {
    ...
    items: [
      { id: 'animal-cat', label: 'cat', imageSrc: '/Grade1/evs/Identify/cat.png' },
      { id: 'animal-dog', label: 'dog', imageSrc: '/Grade1/evs/Identify/dog.png' },
      { id: 'animal-pig', label: 'pig', imageSrc: '/Grade1/evs/Identify/pig.png' },
      { id: 'animal-cow', label: 'cow', imageSrc: '/Grade1/evs/Identify/cow.png' },
      { id: 'animal-goat', label: 'goat', imageSrc: '/Grade1/evs/Identify/goat.png' },
      { id: 'animal-buffalo', label: 'buffalo', imageSrc: '/Grade1/evs/Identify/buffalo.png' },
      { id: 'animal-donkey', label: 'donkey', imageSrc: '/Grade1/evs/Identify/donkey.png' },
      { id: 'animal-horse', label: 'horse', imageSrc: '/Grade1/evs/Identify/horse.png' },
      { id: 'animal-camel', label: 'camel', imageSrc: '/Grade1/evs/Identify/camel.png' }
    ]
  },
  {
    id: 'vehicles',
    ...
    items: [
      { id: 'vehicle-van', label: 'van', imageSrc: '/Grade1/evs/Identify/van.png' },
      { id: 'vehicle-car', label: 'car', imageSrc: '/Grade1/evs/Identify/car.png' },
      { id: 'vehicle-bus', label: 'bus', imageSrc: '/Grade1/evs/Identify/bus.png' },
      { id: 'vehicle-auto', label: 'auto', imageSrc: '/Grade1/evs/Identify/auto.png' },
      { id: 'vehicle-bike', label: 'bike', imageSrc: '/Grade1/evs/Identify/bike.png' },
      { id: 'vehicle-cycle', label: 'cycle', imageSrc: '/Grade1/evs/Identify/cycle.png' },
      { id: 'vehicle-train', label: 'train', imageSrc: '/Grade1/evs/Identify/train.png' },
      { id: 'vehicle-airplane', label: 'airplane', imageSrc: '/Grade1/evs/Identify/airplane.png' },
      { id: 'vehicle-truck', label: 'truck', imageSrc: '/Grade1/evs/Identify/truck.png' }
    ]
  },
  {
    id: 'household',
    ...
    items: [
      { id: 'home-fan', label: 'fan', imageSrc: '/Grade1/evs/Identify/fan.png' },
      { id: 'home-tv', label: 'TV', imageSrc: '/Grade1/evs/Identify/tv.png' },
      { id: 'home-fridge', label: 'fridge', imageSrc: '/Grade1/evs/Identify/fridge.png' },
      { id: 'home-telephone', label: 'tele phone', imageSrc: '/Grade1/evs/Identify/telephone.png' },
      { id: 'home-cellphone', label: 'cell phone', imageSrc: '/Grade1/evs/Identify/cellphone.png' },
      { id: 'home-iron', label: 'iron box', imageSrc: '/Grade1/evs/Identify/iron.png' },
      { id: 'home-ac', label: 'AC', imageSrc: '/Grade1/evs/Identify/ac.png' },
      { id: 'home-computer', label: 'computer', imageSrc: '/Grade1/evs/Identify/computer.png' },
      { id: 'home-geyser', label: 'geyser', imageSrc: '/Grade1/evs/Identify/geyser.png' }
    ]
  }
]
...
export default function EVSIdentify({ onBack, onNextExercise }) {
    ...
    >
      ...
      {correctCount === totalItems && (
        <div style={{ textAlign: 'center', marginBottom: 20 }}>
          <h2 style={{ color: '#4ade80', fontSize: 32, fontWeight: 800 }}>Amazing! You identified everything correctly! 🎉</h2>
          <button
