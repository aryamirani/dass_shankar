    ...
    return (
      ...
      `}</style>
            ...
            <div style={{ textAlign: 'center', background: 'rgba(255,255,255,0.0)', padding: 20 }}>
                ...
                <div style={{ height: 12 }} />
                <div style={{ fontSize: '18px', color: 'white', opacity: 0.95, marginTop: 6, fontWeight: 600, animation: 'popIn 700ms cubic-bezier(.2,.9,.2,1) 120ms both' }}>Explore the wonders of Science</div>
                <div style={{ height: 24 }} />
                <div style={{ display: 'flex', gap: 12, justifyContent: 'center', marginTop: 18 }}>
                    <button className="action-btn" onClick={onStart} style={{ padding: '12px 24px', fontSize: '18px', background: 'white', color: '#ff512f', border: 'none' }}>Start Now</button>
                </div>
            </div>
        </div>
    )
