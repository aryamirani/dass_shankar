...
const ALL_ITEMS = [
  { id: 'medicine', src: '/Grade2/science/Lesson/medicine.png' },
  { id: 'thermometer', src: '/Grade2/science/Lesson/thermometer.png' },
  { id: 'firstaid', src: '/Grade2/science/Lesson/firstaid.png' },
  { id: 'hotdrink', src: '/Grade2/science/Lesson/hotdrink.png' },
  { id: 'food', src: '/Grade2/science/Lesson/food.png' },
  { id: 'tissue', src: '/Grade2/science/Lesson/tissue.png' },
  { id: 'toilet', src: '/Grade2/science/Lesson/toilet.png' },
  { id: 'wetcloth', src: '/Grade2/science/Lesson/wetcloth.png' }
]
      ...
      <div className="main-content" style={{ display: 'flex', flexDirection: 'column', flex: 1 }}>
        ...
        {phase === 'healed' && (
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: 50 }}>
            <img src={'/Grade2/health/Problems/boy.png'} alt="happy" style={{ width: 300 }} />
