...
export default function EnglishWordGame({ onBack, onNextExercise }) {
    ...
    return (
        <div className="landing-root">
            <div className="landing-inner" style={{ alignItems: 'center' }}>
                ...
                {healedWords.length === 5 && (
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 20, marginTop: 40 }}>
                        <h2 style={{ textAlign: 'center', color: '#2e7d32', fontSize: 32 }}>Excellent Work! All words healed! 🎉</h2>
                        <button
