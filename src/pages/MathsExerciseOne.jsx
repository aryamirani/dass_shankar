...
const GENTLE = [
  'Not quite! Count carefully.', 'Almost! Try counting again.', 'Nice try! Double check your count.'
]
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', flexDirection: 'column', padding: 20, position: 'relative' }}>
      ...
      <div style={{ position: 'absolute', right: 20, top: 20 }}>
        <button className="action-btn secondary" onClick={onNextExercise} style={{ padding: '8px 12px' }}>Next: Write the digits</button>
      </div>
