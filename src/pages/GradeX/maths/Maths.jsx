  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', position: 'relative' }}>
      ...
      <div style={{ textAlign: 'center', background: 'rgba(255,255,255,0.0)', padding: 20 }}>
        ...
        <div style={{ height: 12 }} />
        <div style={{ fontSize: 'clamp(18px, 4vw, 20px)', color: 'white', opacity: 0.95, marginTop: 6, animation: 'popIn 700ms cubic-bezier(.2,.9,.2,1) 120ms both' }}>Learn numbers and mathematics through fun exercises</div>
        <div style={{ height: 24 }} />
