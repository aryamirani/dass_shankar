...
export default function MathsExerciseNine({ onBack, onComplete }) {
      ...
      <div style={{ width: '100%', maxWidth: 900, background: 'rgba(255,255,255,0.95)', padding: 'clamp(20px, 4vw, 40px)', borderRadius: 20, boxShadow: '0 10px 40px rgba(0,0,0,0.2)' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 30 }}>
          ...
          {checked && correct && checkedLeft && correctLeft && (
            <div style={{ textAlign: 'center', marginTop: 20, fontSize: 'clamp(24px, 6vw, 36px)', fontWeight: 900, color: '#4CAF50', animation: 'popIn 600ms cubic-bezier(.2,.9,.2,1) both' }}>
              🎉 Excellent work! 🎉
            </div>
          )}
        </div>
