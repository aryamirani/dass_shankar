    ...
    return (
      ...
      `}</style>
            ...
            <div style={{ textAlign: 'center', background: 'rgba(255,255,255,0.0)', padding: 20 }}>
                ...
                <div style={{ height: 12 }} />
                <div style={{ fontSize: 20, color: 'white', opacity: 0.95, marginTop: 6, fontWeight: 600, animation: 'popIn 700ms cubic-bezier(.2,.9,.2,1) 120ms both' }}>Learn about common health issues</div>
                <div style={{ height: 24 }} />
